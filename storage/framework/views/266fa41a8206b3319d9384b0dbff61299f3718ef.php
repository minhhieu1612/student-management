...
<div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <select class="form-control custom-select" name="TenLop" id="TenLop" value="">
                ...
                <option value="<?php echo e($lop->TenLop); ?>" <?php echo e('' == $malop ? '' : ($malop==$lop->MaLopHoc? 'selected': '')); ?>><?php echo e($lop->TenLop); ?></option>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <select class="form-control custom-select" name="MonHoc" id="MonHoc" value="">
                ...
                <option value="<?php echo e($monhoc->MaMonHoc); ?>" <?php echo e('' == $mamon ? '' : ($mamon==$monhoc->MaMonHoc? 'selected': '')); ?>><?php echo e($monhoc->TenMonHoc); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
          </div>
            ...
            <div class="col-md-8">
              <select class="form-control custom-select" name="NamHoc" id="NamHoc" value="">
                <?php $__currentLoopData = $namhocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($nh->NamHoc); ?>" <?php echo e('' == $namhoc ? '' : ($namhoc==$nh->NamHoc? 'selected': '')); ?>><?php echo e($nh->NamHoc); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <select class="form-control custom-select" name="HocKy" id="HocKy" value="">
                <option value="1" <?php echo e('' == $hocky ? '' : ($hocky==1? 'selected': '')); ?>>Học kỳ 1</option>
                <option value="2" <?php echo e('' == $hocky ? '' : ($hocky==2? 'selected': '')); ?>>Học kỳ 2</option>
              </select>
            </div>
          </div>
        </div>
  ...
  <div class="text-center mt-5">
    <a href="/diem/sua/<?php echo e(request('TenLop') ."/". request('MonHoc') ."/". request('NamHoc') ."/". request('HocKy')); ?>"><button
